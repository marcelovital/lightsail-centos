...
sh<(https://raw.githubusercontent.com/marcelovital/lightsail-centos/main/tools-centos7.sh) | gawk '{ print strftime("[%Y-%m-%d %H:%M:%S]"), $0 }' | tee -a /home/centos/centos-deploy.log
...
# echo "===== Update Kernel =====" | gawk '{ print strftime("[%Y-%m-%d %H:%M:%S]"), $0 }' | tee -a /home/centos/centos-deploy.log
# sh<(https://raw.githubusercontent.com/marcelovital/lightsail-centos/main/podman2-centos7.sh) | gawk '{ print strftime("[%Y-%m-%d %H:%M:%S]"), $0 }' | tee -a /home/centos/centos-deploy.log
...
# echo "===== Update Kernel =====" | gawk '{ print strftime("[%Y-%m-%d %H:%M:%S]"), $0 }' | tee -a /home/centos/centos-deploy.log
# sh<(https://raw.githubusercontent.com/marcelovital/lightsail-centos/main/kernelupgrade-centos7.sh) | gawk '{ print strftime("[%Y-%m-%d %H:%M:%S]"), $0 }' | tee -a /home/centos/centos-deploy.log
